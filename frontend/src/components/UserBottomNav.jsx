...
export default function UserBottomNav({ navigate, active = 'home' }) {
  ...
  return (
    <nav
      aria-label="고객 메인 탭"
      className="relative z-50 w-full shrink-0 bg-white border-t border-gray-100 flex shadow-[0_-1px_8px_rgba(0,0,0,0.06)] pb-[max(0px,env(safe-area-inset-bottom,0px))]"
    >
      {tabs.map((t) => {
